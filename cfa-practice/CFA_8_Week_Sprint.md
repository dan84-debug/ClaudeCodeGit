...
* **Curriculum Focus:**
    * FSA.pdf — LM 3: Multinational Operations [Page 116], Sections: "Disclosures Related To Foreign Currency Transaction Gains And Losses" [Page 125], "Translation Of Foreign Currency Financial Statements" [Page 131], "Translation Methods" [Page 135], "Illustration Of Translation Methods" [Page 143], "Translation Analytical Issues" [Page 147], "Translation In An Hyperinflationary Economy" [Page 157], "Using Both Translation Methods" [Page 162], "Additional Disclosures On The Effects Of Foreign Currency" [Page 171]
    * FSA.pdf — LM 1: Intercorporate Investments [Page 4], Sections: "Investments In Associates And Joint Ventures" [Page 11], "Amortization Of Excess Purchase Price, Fair Value Option, And Impairment" [Page 15], "Acquisition Method" [Page 24], "The Consolidation Process" [Page 31], "Additional Issues In Business Combinations That Impair Comparability" [Page 43]
    * FSA.pdf — LM 2: Employee Compensation: Post-Employment and Share-Based [Page 64], Sections: "Financial Reporting For Post-Employment Benefits" [Page 89], "Financial Modeling And Valuation Considerations For Post-Employment Benefits" [Page 100]
* **CFAI Practice Problem Sets:**
    * FSA.pdf — LM 3 Practice Problems (Questions 3, 6, 10, 14, 17, 19, 23–28, 31–34, 35–40: Q3 FC gain/loss on 31 Dec settlement date vs transaction date; Q6 Cendaró hyperinflation IFRS — restate for inflation then translate all at current rate; Q10 Triofind-B temporal method — cash at current rate, inventory at weighted-average historical rate; Q14 Triofind-A IFRS hyperinflation — restate CPI-adjusted then current rate; Q17 Eurexim Ukraine IFRS restate-then-translate vs US GAAP temporal; Q19 temporal method applies when euro is the functional currency; Q23–28 Consol-Can ratio analysis — current rate preserves ratios, temporal distorts fixed-asset and inventory ratios; Q31–34 Augustus current rate method — all I/S items at average rate, CTA to equity/OCI, gross margin less distorted than temporal; Q35–40 Acceletron method identification and ratio analysis — inventory at historical under temporal, receivables at current, ratio impacts)
    * FSA.pdf — LM 1 Practice Problems (Questions 10, 12–14, 26, 29–33: Q10 Cinnamon full goodwill vs partial goodwill — D/E ratio highest under full goodwill consolidation; Q12–14 Oxbow excess purchase price — only amortize depreciable assets, equipment FV > BV means depreciation adjustment SUBTRACTS from equity income; Q26 Rainer 15% equity method — carrying value includes amortization of excess plant over useful life; Q29–33 NinMount full vs partial goodwill, NCI effect on consolidated D/E, depreciable vs non-depreciable excess)
    * FSA.pdf — LM 2 Practice Problems (Questions 2, 3, 5, 8, 9: Q2 Kensington IFRS funded status = plan assets − PBO; Q3 IFRS net interest on obligation ≠ actual return on plan assets — IFRS uses net pension liability × discount rate; Q5 actuarial gains/losses → OCI under IFRS, never P&L; Q8 XYZ IFRS FY2025 operating expense = current service cost + past service cost = 200 + 120 = 320; Q9 US GAAP I/S expense = service cost + interest cost − expected return on plan assets ± amortizations)
* **Flashcards (Rote Memorization):**
...
* **Curriculum Focus:**
    * FSA.pdf — LM 2: Employee Compensation: Post-Employment and Share-Based [Page 64], Sections: "Financial Reporting For Share-Based Compensation" [Page 69], "Share-Based Compensation Tax And Share Count Effects, Note Disclosures" [Page 77], "The Debate Over Accounting For Share-Based Compensation" [Page 76], "The Shift To Restricted Stock" [Page 76]
    * FSA.pdf — LM 4: Analysis of Financial Institutions [Page 202], Sections: "Analyzing A Bank: The CAMELS Approach" [Page 209], "Analyzing A Bank: Non-CAMELS Factors" [Page 226], "Analyzing A Bank: Example Of CAMELS Approach" [Page 230], "Analyzing Property And Casualty Insurance Companies" [Page 253]
    * FSA.pdf — LM 5: Evaluating Quality of Financial Reports [Page 286], Sections: "Earnings Quality Indicators" [Page 307], "Earnings Persistence And Related Measures Of Accruals" [Page 311], "Cash Flow Quality" [Page 331], "Balance Sheet Quality" [Page 341]; LM 1: Intercorporate Investments [Page 4], Section: "Investments In Financial Assets: IFRS 9" [Page 7]
    * issuers.pdf — LM 4: Corporate Restructuring [Page 156], Sections: "Evaluating Corporate Restructurings" [Page 173], "Modeling And Valuation" [Page 182], "Evaluating Investment Actions" [Page 189]
* **CFAI Practice Problem Sets:**
    * FSA.pdf — LM 2 Practice Problems (Questions 11, 15, 16, 17, 18: Q11 XYZ lower volatility → lower grant-date FV → lower annual expense = total FV ÷ vesting period (3 years), NOT option life; Q15 SKI windfall = statutory rate × (market price at settlement − grant-date FV) × shares settled; company receives STRIKE price as cash, not market price; Q16 IFRS windfall → equity, no P&L impact vs US GAAP windfall → reduces income tax expense in I/S; Q17 SKI diluted shares — treasury stock method: gross RSUs − (unrecognized comp ÷ avg share price); Q18 lower share price → fewer assumed repurchases → more dilution, higher share count)
    * FSA.pdf — LM 4 Practice Problems (Questions 4, 5, 6, 9, 12: Q4 underwriting expense ratio = underwriting expenses ÷ net premiums WRITTEN; Q5 loss ratio = net claims incurred ÷ net premiums EARNED — not written; Q6 most efficient insurer = lowest combined ratio (loss + expense); Q9 CET1 ratio = (common equity − intangibles − deferred tax assets) ÷ risk-weighted assets; AT1 is NOT included in CET1 numerator; Q12 Company XYZ loan loss — allowance/net charge-offs declining 3.84 → 1.45 for commercial loans = less conservative provisioning, provision increases allowance, charge-offs decrease it)
    * FSA.pdf — LM 5 Practice Problems (Questions 2, 3, 7, 11, 13, 16, 17: Q2 NI > OCF = earnings quality warning sign; Q3 β1(cash) > β2(accruals) confirms cash earnings more persistent than accrual earnings; Q7 accrual ratios — use ABSOLUTE VALUE, lower |ratio| = higher quality regardless of sign; Q11 Beneish M-score for BIG Industrial = −1.54 exceeds −1.78 cutoff indicating possible manipulation; Q13 goodwill impairment: total CGU impairment = €500K, goodwill absorbs first €300K, remaining €200K allocated to other assets proportionally; Q16 Stellar understated amortizable intangibles at Solar acquisition → amortization expense understated → earnings overstated; Q17 discretionary accruals as indicator of intentional manipulation vs non-discretionary accruals); LM 1 Practice Problems (Questions 1–6: Q1–3 FVPL: interest + FV changes to P&L; FVOCI: coupon to P&L, FV changes to OCI; amortized cost: coupon only; Q4–6 US GAAP interest received MUST be classified as operating — no flexibility, unlike IFRS)
    * issuers.pdf — LM 4 Practice Problems (Questions 3, 4, 6, 8: Q3 Jupiter cap rate at 50th percentile = "supported by comparable transactions" — use implied cap rate, not company's borrowing rate; Q4 Saturn EV/EBITDA — compute each comparable's multiple individually (19×, 17×, 13×) then take median; do NOT average raw EBITDAs and divide; Q6 combined Stratton + Midwest Year 3 operating income = sum of individual operating incomes + net synergies (Year 3: $350M synergies − $395M cash costs = −$45M net); Q8 post-acquisition equity weight = 71% — debt = pre-existing Stratton debt + assumed Midwest debt + new issuance = $62B total; equity = 1.2B shares × $125 = $150B)
* **Flashcards (Rote Memorization):**
...
* **Curriculum Focus:**
    * equiuty.pdf — LM 5: Residual Income Valuation [Page 337], Sections: "The Residual Income Model" [Page 343], "Single-Stage And Multistage Residual Income" [Page 351], "Relationship To Other Approaches" [Page 358], "Accounting And International Considerations" [Page 362], "Accounting Considerations: Other" [Page 372]
    * equiuty.pdf — LM 3: Free Cash Flow Valuation [Page 125], Sections: "Forecasting Free Cash Flow And Computing" [Page 131], "Fcff From Net Income" [Page 131], "Computing Fcfe From Fcff" [Page 141], "Two-Stage Free Cash Flow Models" [Page 164], "Three-Stage Free Cash Flow Models" [Page 172], "Non-Operating Assets And Firm Value" [Page 177]; LM 1: Equity Valuation: Applications and Processes [Page 3], Section: "Selecting The Appropriate Valuation Method" [Page 23]
    * equiuty.pdf — LM 2: Discounted Dividend Valuation [Page 49], Sections: "The Dividend Discount Model" [Page 59], "The Gordon Growth Model" [Page 63], "Multistage Dividend Discount Models" [Page 77], "The H-Model And Three-Stage Dividend Discount Models" [Page 83], "General Modeling And Estimating A Required Return Using Any Ddm" [Page 90]; issuers.pdf — LM 1: Analysis of Dividends and Share Repurchases [Page 3], Sections: "Payout Policies" [Page 25], "Share Repurchases" [Page 29]
    * equiuty.pdf — LM 4: Market-Based Valuation: Price and Enterprise Value Multiples [Page 221], Sections: "Price/Earnings: Valuation Based On Forecasted Fundamentals" [Page 239], "Price/Book Value" [Page 257], "Deriving The Justified P/B Expression" [Page 257], "Justified P/B Expression Based On Residual Income" [Page 266]; FSA.pdf — LM 4: Analysis of Financial Institutions [Page 202], Section: "Analyzing Property And Casualty Insurance Companies" [Page 253]
* **CFAI Practice Problem Sets:**
    * equiuty.pdf — LM 5 Practice Problems (Questions 15–16, 17–26, 42: Q15–16 Amersheen multistage RI — finite-horizon Scenario 1/2 terminal values; Q17 Castovan — RI model assumes clean surplus accounting; Q19 OCI bypasses income statement → violates clean surplus, must include OCI in NI for equity charge; Q21 SSX single-stage RI → solve implied growth rate; Q22 TTCI single-stage RI → over/undervalued threshold; Q23 justified P/B = (ROE−g)/(r−g) for TTCI; Q24 multistage RI intrinsic value for TTCI using 3-year explicit + terminal value; Q25–26 persistence factor ω: low ω means extreme ROE reverts quickly; Q42 finite-horizon RI: TV = RI_T/[(1+r−ω)(1+r)^(T−1)] — discount T−1 periods, not T)
    * equiuty.pdf — LM 3 Practice Problems (Questions 1–2, 7, 12–13, 28, 30–31: Q1–2 Shimotsuke FCFF vs FCFE — FCFF firm value requires subtracting debt to get equity value; Q7 Company A FCFE preferred because stable leverage and dividends poorly reflect cash-generating capacity; Q12 two-stage FCFE model for Company B; Q13 single-stage FCFF → subtract debt for equity; Q28 Smith recommends FCFF because Holt's capital structure is expected to change; Q30–31 Sundanci two-stage FCFE — FCFE coverage ratio denominator = dividends + share repurchases only); LM 1 Practice Problems (Questions 8, 13–15: Q8 VEGA model selection — FCFE preferred when no dividends and acquisition possible; Q13 Company A absolute valuation → FCFF model most appropriate; Q15 control premium appropriate when evaluating acquisition perspective)
    * equiuty.pdf — LM 2 Practice Problems (Questions 5, 18, 29–31, 38: Q5 H-model with H=4 — use H directly, do NOT compute 0.5×H; H is already the half-life; Q18 Tasty Foods ±10% fair-value band — check threshold BEFORE concluding over/undervalued; Q29 Withers estimated stock value at end of first stage using H-model; Q31 H-model vs basic two-stage DDM — H-model yields lower value because growth declines linearly in Stage 1; Q38 Xavier implied growth rate via H-model formula); issuers.pdf — LM 1 Practice Problems (Question 16: Q16 Berkshire Gardens target payout adjustment — Increase = (Target×EPS − Prev Div) ÷ n = (0.25×$4.00 − $0.60) ÷ 5 = $0.08; New Div = $0.60 + $0.08 = $0.68)
    * equiuty.pdf — LM 4 Practice Problems (Questions 17–19, 23–25, 30: Q17 trailing P/E for Centralino includes (1+g) factor; Q18 justified forward P/E using GGM fundamentals; Q19 price-to-book multiple for Centralino; Q23 E/P based on trailing earnings for Adesivo; Q24 diluted trailing EPS with nonrecurring adjustments; Q25 forward PEG ratios comparison; Q30 Sundanci justified forward P/E = (1−b)/(r−g) — trailing P/E = forward P/E × (1+g)); FSA.pdf — LM 4 Practice Problems (Questions 4–5: Q4 underwriting expense ratio = expenses ÷ net premiums WRITTEN; Q5 loss ratio = claims ÷ net premiums EARNED — see Weekend 4 for full detail)
* **Flashcards (Rote Memorization):**
...
* **Curriculum Focus:**
    * equiuty.pdf — LM 6: Private Company Valuation [Page 405], Sections: "Public Vs. Private Company Valuation" [Page 407], "Earnings Normalization And Cash Flow" [Page 415], "Private Company Discount Rates And Required Rates Of Return" [Page 423], "Valuation Discounts And Premiums" [Page 429], "Private Company Valuation Approaches" [Page 435], "Private Company Valuation: Income-Based" [Page 447], "Private Company Valuation: Market-Based" [Page 451]
    * alts.pdf — LM 3: Investments in Real Estate through Publicly Traded Securities [Page 121], Sections: "Types Of Publicly Traded Real Estate" [Page 123], "Valuation: Net Asset Value Approach" [Page 126], "Valuation: Relative Value (Price Multiple)" [Page 132], "Reit Mini Case Study: Example Of Disclosures And Valuation Analysis" [Page 136], "Private Vs. Public: A Comparison" [Page 144]
    * alts.pdf — LM 1: Introduction to Commodities and Commodity Derivatives [Page 3], Sections: "Commodity Sectors" [Page 5], "Commodity Spot And Futures Pricing" [Page 20], "Theories Of Futures Returns" [Page 25], "Components Of Futures Returns" [Page 31], "Contango, Backwardation, And The Roll" [Page 36]
    * alts.pdf — LM 4: Hedge Fund Strategies [Page 165], Sections: "Introduction And Classification Of Hedge Fund Strategies" [Page 167], "Opportunistic Strategies: Global Macro" [Page 201], "Opportunistic Strategies: Managed Futures" [Page 203], "Multi-Manager Strategies" [Page 215], "Portfolio Contribution Of Hedge Fund" [Page 235]
* **CFAI Practice Problem Sets:**
    * equiuty.pdf — LM 6 Practice Problems (Questions 3, 10, 11–15: Q3 normalizing earnings = adjustments to revenues/costs for private vs public comparability; Q10 DLOM using put option approach — at-the-money option on comparable public company; Q11 LPE normalized EBITDA — CEO Jean Lapiere paid EUR 0.3M below market rate, increase SG&A to market rate; Q12 build-up method discount rate = ERP + size premium + SCRP; Q13 CCM firm value using capitalized income approach; Q14 equity value using EV/Sales market multiple (0.60×); Q15 total discount = 1 − (1−DLOC)(1−DLOM) = 1 − (0.80)(0.85) = 32%)
    * alts.pdf — LM 3 Practice Problems (Questions 2–5, 14, 16: Q2 NAVPS statements — Statement 2 correct: high transaction volume helps NAV estimation; Q3 FFO/AFFO statements — Statement 6 incorrect: AFFO does NOT add back straight-line rent; correct AFFO = FFO − maintenance capex; Q4 Bay's P/FFO = price ÷ FFO per share; Q5 REITs are tax-advantaged; REOCs can reinvest 100% — REITs must distribute ≥90% (limited retained earnings growth); Q14 AFFO is refinement of FFO — best measure to address distortions from one-time items; Q16 Baldwin REIT intrinsic value using two-step DCF)
    * alts.pdf — LM 1 Practice Problems (Questions 2, 7, 13–15, 18: Q2 government actions affect all four commodity sectors — weather affects sectors unevenly, consumer preferences is wrong; Q7 Apex Fund soybean 3-month total return = spot price return + roll return + collateral return; Q13 soybean futures — two observations support theory of storage (convenience yield > storage cost AND producers hedge more than consumers); Q14 natural gas total return = price return + roll return (negative in contango) + collateral return; Q15 investment positions evaluated on total return basis, not just price or roll return alone; Q18 energy backwardation — consumed in real-time, minimal storage → high convenience yield)
    * alts.pdf — LM 4 Practice Problems (Questions 2, 8, 20, 23: Q2 event-driven strategies do face equity market beta risk — Statement 2 is incorrect; Q8 FoF vs MSF — FoF CANNOT quickly reallocate capital between strategies; MSF can rapidly increase/decrease leverage per strategy (IC member's FoF tactical advantage claim is wrong); Q20 Puten: global macro strategy appropriate for directional bets on macro trends; Q23 Singh: 10% global macro allocation reduces max drawdown to 15% and increases both Sharpe and Sortino ratios)
* **Flashcards (Rote Memorization):**
