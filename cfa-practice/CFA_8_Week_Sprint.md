...
* **Curriculum Focus:**
    * quants.pdf — LM 1: Basics of Multiple Regression and Underlying Assumptions, Section: "Assumptions Underlying Multiple Linear"; LM 2: Evaluating Regression Model Fit and Interpreting Model Results, Sections: "Goodness Of Fit", "Testing Joint Hypotheses For Coefficients"; LM 3: Model Misspecification, Sections: "Violations Of Regression Assumptions: Heteroskedasticity" (Code: Breusch–Pagan Test), "Violations Of Regression Assumptions: Serial Correlation" (Code: Breusch–Godfrey Test), "Violations Of Regression Assumptions: Multicollinearity"
    * quants.pdf — LM 5: Time-Series Analysis, Sections: "Linear Trend Models", "Log-Linear Trend Models", "Ar Time-Series Models And Covariance-Stationary Series", "Mean Reversion And Multiperiod Forecasts", "Comparing Forecast Model Performance", "Random Walks", "The Unit Root Test Of Nonstationarity", "Regressions With More Than One Time Series"
    * quants.pdf — LM 6: Machine Learning, Sections: "Evaluating Ml Algorithm Performance", "Support Vector Machine", "Classification And Regression Tree", "Ensemble Learning And Random Forest", "Neural Networks, Deep Learning Nets, And Reinforcement Learning", "Choosing An Appropriate Ml Algorithm"; LM 7: Big Data Projects, Section: "Performance Evaluation"
    * PM.pdf — LM 6: Backtesting and Simulation, Sections: "The Objectives Of Backtesting", "The Backtesting Process", "Common Problems In Backtesting"
* **CFAI Practice Problem Sets:**
    * quants.pdf — LM 1 Practice Problems (regression assumptions), LM 2 Practice Problems (F-test joint significance, R² vs adjusted R², AIC vs BIC), LM 3 Practice Problems (Breusch-Pagan, Durbin-Watson, VIF interpretation)
    * quants.pdf — LM 5 Practice Problems (AR forecasting on first differences, Dickey-Fuller null/alternative, cointegration residual tests, log-linear prediction with exponentiation, mean-reverting level = b₀/(1−b₁))
    * quants.pdf — LM 6 Practice Problems (SVM soft margin vs hard margin, bias-variance tradeoff, overfitting detection, neural network for non-linear regression), LM 7 Practice Problems (confusion matrix: Precision, Recall, F1 Score, Accuracy)
    * PM.pdf — LM 6 Practice Problems (rolling windows, data snooping vs survivorship vs look-ahead bias)
...
* **Curriculum Focus:**
    * Econ.pdf — LM 2: Economic Growth, Sections: "Production Function And Growth", "Capital Deepening Vs. Technological", "Labor Supply", "Theories Of Growth", "Implications Of Neoclassical Model", "Extension Of Neoclassical Model", "Endogenous Growth Model", "Convergence Hypotheses", "Growth In An Open Economy"
    * Econ.pdf — LM 1: Currency Exchange Rates: Understanding Equilibrium Value, Sections: "Monetary And Fiscal Policies", "The Mark-To-Market Value Of A Forward", "Forward Markets", "Capital Flows"
    * PM.pdf — LM 1: Economics and Investment Markets, Sections: "Conventional Government Bonds And Break-Even Inflation Rates", "Equities And The Equity Risk Premium", "How Big Is The Equity Risk Premium?"; issuers.pdf — LM 3: Cost of Capital: Advanced Topics, Section: "The Cost Of Equity (Required Return On"; Econ.pdf — LM 1, Section: "Warning Signs Of A Currency Crisis"
* **CFAI Practice Problem Sets:**
    * Econ.pdf — LM 2 Practice Problems (steady-state growth rate, TFP decomposition, club vs conditional convergence, potential GDP = labor force growth + labor productivity growth, permanent vs temporary growth factors)
    * Econ.pdf — LM 1 Practice Problems (Mundell-Fleming high vs low capital mobility, forward MTM with signed forward points, offsetting long/short base currency)
    * PM.pdf — LM 1 Practice Problems (BEI = expected inflation + risk premium); issuers.pdf — LM 3 Practice Problems (macroeconomic ERP build-up: DY + Δ(P/E) + i + g − ΔS − Rf); Econ.pdf — LM 1 Practice Problems (rising M2/reserves = warning sign)
* **Flashcards (Rote Memorization):**
