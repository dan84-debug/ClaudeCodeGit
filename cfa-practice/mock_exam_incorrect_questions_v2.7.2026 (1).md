...
- Mock 2 (February 2026 - Axiom/Lonza): 24/44 (55%)
- Mock 3 (February 2026 - Buttery/Aoun): 27/44 (61%)
- **Total: 107/176 (61%)**
...
### Q7 — Time Series Properties (Mock 3 - Aoun)

**Full Vignette Context:**
Aoun considers company fundamentals and predicts the growth in quarterly sales for Circuitcraft. He gathers quarterly sales data for the past 13 years and runs a regression using the first difference of quarterly sales growth in an AR(2) model. After reviewing the first-differenced time-series data, Aoun determines that the mean and the variance are constant over time. Aoun concludes that the time series does not have a unit root.

**Exhibit 2 - Autocorrelations of the Residual:**
| Lag | Autocorrelation | Standard Error | t-Statistic |
|-----|-----------------|----------------|-------------|
| 1 | –0.1825 | 0.1414 | –1.2907 |
| 2 | –0.0716 | 0.1414 | –0.5061 |
| 3 | –0.2606 | 0.1414 | –1.8424 |
| 4 | 0.0609 | 0.1414 | 0.4306 |

Critical value: t = 2.0 at 5% significance level

**Question:**
The first-differenced time series for Circuitcraft's growth in quarterly sales:

A. is a random walk
B. exhibits seasonality
C. is covariance stationary

**Your Answer:** A (is a random walk)

**Correct Answer:** C (is covariance stationary)

**Full Explanation:**

**Why NOT a Random Walk:**
A random walk means x_{t-1} is the best forecast of x in every period. But the regression shows b2 = –0.5272 with t-stat = –4.34, which is significant (|–4.34| > 2.0). Therefore, past values beyond t-1 help predict x, so it's NOT a random walk.

**Why NOT Seasonality:**
Seasonality in quarterly data would show significant autocorrelation at lag 4. The t-statistic for lag 4 is only 0.4306, which is far below the critical value of 2.0. No significant seasonal autocorrelation exists.

**Why IS Covariance Stationary:**
Three requirements for covariance stationarity:
1. Mean is constant ✓ (stated in vignette)
2. Variance is constant ✓ (stated in vignette)
3. Covariance with itself is constant ✓ (residuals are uncorrelated - no lag has |t-stat| > 2.0)

All three conditions are met.

---

### Q13 — ETF Holding Period Cost (Mock 3 - Li Guoqing)

**Full Vignette Context:**
Li Guoqing is a fund manager who is reviewing four similar ETFs. He calculates the expected 1-year holding period cost for ETF 1.

**Exhibit 1:**
| Item | ETF 1 |
|------|-------|
| Annual management fee | 0.50% |
| One-way trading commission | 0.10% |
| Bid–ask spread on purchase and sale | 0.20% |

**Question:**
Excluding any compounding effects, the expected 1-year holding period cost for investing in ETF 1 is:
...
|--------|-------------|-------|
| A (0.80%) | 0.10% + 0.20% + 0.50% | One-way commission only |
| **B (0.90%)** | 0.20% + 0.20% + 0.50% | **Correct** |
| C (1.10%) | 0.20% + 0.40% + 0.50% | Full spread × 2 instead of half |
...
### Q25 — Valuation Model Selection (Mock 3 - Bala)

**Full Vignette Context:**
Ulu Bala is valuing Firm A, a rapidly growing automotive parts distributor. Information about Firm A:
- Dividend payout ratio has been stable over last 10 years and expected to remain stable
- Planned expansion into new markets will require significant annual capital expenditures
- **Dividends will exceed free cash flow to equity** due to expansion spending
- Compared with peers, firm has aggressive policy on reported earnings and lower quality accounting disclosure

**Question:**
Which of the following valuation models is most appropriate for Firm A?

A. Free cash flow model
B. Residual income model
C. Dividend discount model

**Your Answer:** C (Dividend discount model)

**Correct Answer:** A (Free cash flow model)
...
| Model | Best When |
|-------|-----------|
| **FCFE/FCFF** | **Dividends significantly exceed or fall short of FCFE** |
| Residual Income | Good quality accounting disclosure |
| DDM | Dividends bear consistent relationship to profitability |

**Why FCFE Model:**
- Firm A's dividends will **exceed** FCFE due to expansion spending
- This makes DDM inappropriate because dividends don't reflect sustainable cash generation
- FCFE/FCFF better captures the firm's true cash-generating ability

**Why NOT Residual Income:**
- Firm has "lower quality of accounting disclosure"
- Residual income model requires good quality accounting to properly adjust net income and book value

**Why NOT DDM:**
- Dividend policy will NOT bear "understandable and consistent relationship to profitability" going forward
- Past stability is irrelevant given planned expansion

---

### Q26 — DDM Valuation (Mock 3 - Bala)

**Full Vignette Context:**
Bala uses DDM to value Firm B, a regional utilities provider.
- Current stock price: $19.00
- Required return on equity: 8%
- Retention ratio: 60% (dividend payout = 40%)
- Expected price at end of Year 3: $21.50
- ValEwe considers stock fairly valued if within 2% of estimated fair value

**Exhibit 1 - Forecasted EPS:**
| Year | EPS |
|------|-----|
| 1 | $1.27 |
| 2 | $1.62 |
...
**Question:**
Based on the dividend discount model, Bala should consider Firm B's common stock to be:

A. undervalued
B. fairly valued
C. overvalued

**Your Answer:** C (overvalued)

**Correct Answer:** B (fairly valued)

**Full Explanation:**

**Calculate Dividends (40% payout):**
> D1 = $1.27 × 40% = $0.508
> D2 = $1.62 × 40% = $0.648
> D3 = $1.91 × 40% = $0.764

**DDM Valuation:**
> V₀ = D1/(1.08)¹ + D2/(1.08)² + D3/(1.08)³ + P3/(1.08)³
> = $0.508/1.08 + $0.648/1.1664 + $0.764/1.2597 + $21.50/1.2597
> = $0.47 + $0.56 + $0.61 + $17.07
> = **$18.70**

**Valuation Decision:**
> Price deviation = ($19.00 – $18.70) / $18.70 = **1.6%**
> 1.6% < 2% threshold → **Fairly valued**

**Why You Got It Wrong:**
You may have concluded overvalued because price ($19.00) exceeds fair value ($18.70). But ValEwe's policy considers stocks fairly valued if within 2% of fair value.

---

### Q29 — ABS Credit Analysis (Mock 3 - Kehoe)

**Full Vignette Context:**
Cathryn Kehoe is conducting credit analysis of an ABS held in the pension fund's portfolio. The ABS is backed by a large number of short-term credit card receivables that are homogeneous. Each receivable is small relative to the total value of the pool.

**Question:**
Based on the characteristics of the receivables backing the ABS, which credit analysis approach is most appropriate?
...
**ABS Characteristics:**
| Characteristic | This ABS |
|----------------|----------|
| Time horizon | Short-term |
| Pool composition | Granular (many small receivables) |
| Homogeneity | Homogeneous |

**Credit Analysis Approach Decision:**
...
For credit card ABS with many small, similar receivables, investors use aggregate statistics (mean default probability, recovery rate, variance) rather than individual loan analysis.

**Why NOT Portfolio-Based:**
Portfolio-based is for pools that change over time (dynamic). "Short-term" indicates the pool is relatively static.

---

### Q31 — CDS Upfront Premium (Mock 3 - Kehoe)

**Full Vignette Context:**
The fund owns $5 million of a 7-year senior unsecured bond issued by Gonk Industries. Kehoe recommends the fund buy $5 million of credit protection on Gonk using a 5-year CDS.
...
**Calculation:**
> Upfront % = (4.0% – 5.0%) × 4.5 = –4.5%
> Upfront $ = –4.5% × $5,000,000 = **–$225,000**

The negative sign means the protection SELLER pays the premium to the protection BUYER.

**Why Seller Pays:**
- Fixed coupon (5.0%) > current credit spread (4.0%)
...
**Key Rule:** Use CDS DURATION, not maturity.
...
### Q31 — Two-Stage FCFE Valuation (Mock 1)
...
### Q26 — Currency Swap Fixed Rate (Mock 1)
...
### Q28 — Forward Contract Value at Time t (Mock 1)
...
|-------|--------|--------|--------|-------|----------|
| Fixed Income/Credit | 6 | 6 | 4 | 16 | **HIGH** |
| FSA | 5 | 1 | 3 | 9 | **HIGH** |
| Equity | 6 | 1 | 2 | 9 | **HIGH** |
| Derivatives | 5 | 2 | 0 | 7 | **HIGH** |
| Portfolio Management | 3 | 4 | 2 | 9 | **HIGH** |
| Economics | 2 | 2 | 3 | 7 | MEDIUM |
| Quantitative Methods | 3 | 4 | 2 | 9 | **HIGH** |
| Alternatives | 1 | 3 | 0 | 4 | MEDIUM |
